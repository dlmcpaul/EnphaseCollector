...
@Log4j2
public class MetricCalculatorStandardBattery implements MetricCalculator {

	private static final String ENCHARGE = "ENCHARGE";

	public MetricCalculatorStandardBattery() {
		log.info("Battery Standard Consumption Metric Calculator Activated");
	}
